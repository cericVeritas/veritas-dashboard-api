let getStreamIterator,createBoundary,normalizeValue,isPlainObject,proxyHeaders,isFormData,escapeName,isFile;_b0c‍.x([["FormDataEncoder",()=>FormDataEncoder]]);_b0c‍.w("./util/getStreamIterator.js",[["getStreamIterator",["getStreamIterator"],function(v){getStreamIterator=v}]]);_b0c‍.w("./util/createBoundary.js",[["createBoundary",["createBoundary"],function(v){createBoundary=v}]]);_b0c‍.w("./util/normalizeValue.js",[["normalizeValue",["normalizeValue"],function(v){normalizeValue=v}]]);_b0c‍.w("./util/isPlainObject.js",[["isPlainObject",["isPlainObject"],function(v){isPlainObject=v}]]);_b0c‍.w("./util/proxyHeaders.js",[["proxyHeaders",["proxyHeaders"],function(v){proxyHeaders=v}]]);_b0c‍.w("./util/isFormData.js",[["isFormData",["isFormData"],function(v){isFormData=v}]]);_b0c‍.w("./util/escapeName.js",[["escapeName",["escapeName"],function(v){escapeName=v}]]);_b0c‍.w("./util/isFile.js",[["isFile",["isFile"],function(v){isFile=v}]]);var __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {
