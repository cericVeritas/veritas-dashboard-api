let process,promisify,inspect,URL,URLSearchParams,checkServerIdentity,http,https,is,assert,lowercaseKeys,CacheableLookup,http2wrapper,isFormData,parseLinkHeader;_006‍.x([["default",()=>Options]]);_006‍.w("node:process",[["default",["process"],function(v){process=v}]]);_006‍.w("node:util",[["promisify",["promisify"],function(v){promisify=v}],["inspect",["inspect"],function(v){inspect=v}]]);_006‍.w("node:url",[["URL",["URL"],function(v){URL=v}],["URLSearchParams",["URLSearchParams"],function(v){URLSearchParams=v}]]);_006‍.w("node:tls",[["checkServerIdentity",["checkServerIdentity"],function(v){checkServerIdentity=v}]]);_006‍.w("node:http",[["default",["http"],function(v){http=v}]]);_006‍.w("node:https",[["default",["https"],function(v){https=v}]]);_006‍.w("@sindresorhus/is",[["default",["is"],function(v){is=v}],["assert",["assert"],function(v){assert=v}]]);_006‍.w("lowercase-keys",[["default",["lowercaseKeys"],function(v){lowercaseKeys=v}]]);_006‍.w("cacheable-lookup",[["default",["CacheableLookup"],function(v){CacheableLookup=v}]]);_006‍.w("http2-wrapper",[["default",["http2wrapper"],function(v){http2wrapper=v}]]);_006‍.w("form-data-encoder",[["isFormData",["isFormData"],function(v){isFormData=v}]]);_006‍.w("./parse-link-header.js",[["default",["parseLinkHeader"],function(v){parseLinkHeader=v}]]);
