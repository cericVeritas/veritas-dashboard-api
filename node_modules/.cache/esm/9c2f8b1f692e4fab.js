let Properties,OrganizationModel,InviteModel,authorize,Errors,ErrorManager;_692‍.x([["default",()=>_692‍.o]]);_692‍.w("../properties",[["default",["Properties"],function(v){Properties=v}]]);_692‍.w("../models/OrganizationModel",[["default",["OrganizationModel"],function(v){OrganizationModel=v}]]);_692‍.w("../models/InviteModel",[["default",["InviteModel"],function(v){InviteModel=v}]]);_692‍.w("../security/SecurityManager",[["authorize",["authorize"],function(v){authorize=v}]]);_692‍.w("../classes/Errors",[["default",["Errors"],function(v){Errors=v}]]);_692‍.w("../classes/ErrorManager",[["default",["ErrorManager"],function(v){ErrorManager=v}]]);// Properties
...
const OrganizationController = {
   ...
   get: async (req, res) => {
    ...
    getTeam: async (req, res) => {
        try {
            _692‍.g.console.log('getTeam called with params:', req.params);
            _692‍.g.console.log('getTeam called with URL:', req.url);
            _692‍.g.console.log('getTeam called with path:', req.path);
            ...
            _692‍.g.console.log(organization);
    ...
    getTeamInvites: async (req, res) => {
        try {
            _692‍.g.console.log('getTeamInvites called with params:', req.params);
            _692‍.g.console.log('getTeamInvites called with URL:', req.url);
            ...
            _692‍.g.console.log('🔥team invites',req.params.id,result);
            res.json(result);
        } catch (err) {
            const safeErr = ErrorManager.getSafeError(err);
            res.status(safeErr.status).json(safeErr);
