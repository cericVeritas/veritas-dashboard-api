let Properties,UserModel,InviteModel,OrganizationModel,fs,mailer,Handlebars,authorize,Errors,ErrorManager,randToken,properties,getUserWithToken,signToken;_da2‍.x([["default",()=>_da2‍.o]]);_da2‍.w("../properties",[["default",["Properties","properties"],function(v){Properties=properties=v}]]);_da2‍.w("../models/UserModel",[["default",["UserModel"],function(v){UserModel=v}]]);_da2‍.w("../models/InviteModel",[["default",["InviteModel"],function(v){InviteModel=v}]]);_da2‍.w("../models/OrganizationModel",[["default",["OrganizationModel"],function(v){OrganizationModel=v}]]);_da2‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_da2‍.w("./../services/mailer",[["default",["mailer"],function(v){mailer=v}]]);_da2‍.w("handlebars",[["default",["Handlebars"],function(v){Handlebars=v}]]);_da2‍.w("../security/SecurityManager",[["authorize",["authorize"],function(v){authorize=v}]]);_da2‍.w("../classes/Errors",[["default",["Errors"],function(v){Errors=v}]]);_da2‍.w("../classes/ErrorManager",[["default",["ErrorManager"],function(v){ErrorManager=v}]]);_da2‍.w("rand-token",[["default",["randToken"],function(v){randToken=v}]]);_da2‍.w("../services/userHelpers",[["getUserWithToken",["getUserWithToken"],function(v){getUserWithToken=v}]]);_da2‍.w("../services/jwtHelpers",[["signToken",["signToken"],function(v){signToken=v}]]);
  ...
  */
  ...
  getInviteByCode: async (req, res) => {
    try {
        ...
        _da2‍.g.console.log(inviteCode);
        const inviteLookup = await InviteModel.findByCode(inviteCode);
        _da2‍.g.console.log(inviteLookup);
  ...
  */
  update: async (req, res) => {
    try {
        ...
        if(type){
            delete data.type;
            _da2‍.g.console.log(type);
            _da2‍.g.console.log(data.tokenid);
  ...
  */
  signup: async (req, res) => {
      try {
          ...
          // }
          _da2‍.g.console.log('body 🔥',req.body);

          let code = req.body.ic;
          let inviteLookup = await InviteModel.findByCode(code);
          _da2‍.g.console.log('invite️‍🔥',code,inviteLookup);
