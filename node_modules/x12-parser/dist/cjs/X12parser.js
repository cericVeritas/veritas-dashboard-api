...
class X12parser extends node_stream_1.Transform {
    #decoder;
    #firstLine;
    #leftOver;
    #delimiters;
    ...
    constructor(defaultEncoding = 'ascii') {
        ...
        this.#decoder = new node_string_decoder_1.StringDecoder(defaultEncoding);
        this.#firstLine = true;
        this.#leftOver = '';
        this.#delimiters = {
            segment: '',
    ...
    generateSegments(segments) {
        segments.forEach((item) => {
            const segment = new Segment_js_1.Segment(item, this.#delimiters);
