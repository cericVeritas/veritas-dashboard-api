let Database,mongoose,Schema,OrganizationModel,Logger;_c46‍.x([["default",()=>_c46‍.o]]);_c46‍.w("../classes/database_veritas",[["default",["Database"],function(v){Database=v}]]);_c46‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}],["Schema",["Schema"],function(v){Schema=v}]]);_c46‍.w("./OrganizationModel",[["default",["OrganizationModel"],function(v){OrganizationModel=v}]]);_c46‍.w("../classes/Logger",[["default",["Logger"],function(v){Logger=v}]]);
// Database
...
const userModel = {
     ...
     */
    init() {
        const db = _c46‍.a("Database",Database).getConnection();

        /**
         * User
         */
        const userSchema = new (_c46‍.a("mongoose",mongoose)).Schema({
        ...
        userModel.setModel(_c46‍.a("mongoose",mongoose).model("User", userSchema));
    ...
    async getUnverifiedOrganization(id) {
        return await _c46‍.a("OrganizationModel",OrganizationModel).model.findOne({
            _admins: id,
            verifiedEmail: null,
        });
    },
...
_c46‍.d(userModel);_c46‍.j(["default"]);
